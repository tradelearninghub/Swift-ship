      ...
      <div className="main-container max-w-4xl mx-auto px-4 space-y-8">
        ...
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 text-brand-primary text-xs font-bold border border-blue-200">
            <Calculator className="w-3.5 h-3.5" /> Automated Pricing Engine
          </div>
          ...
          <div className="md:col-span-6">
            ...
            <div className="mt-4 p-4 bg-amber-50/80 border border-amber-200 rounded-xl space-y-1.5 text-xs text-amber-950">
              ...
              <p className="text-[11px] leading-relaxed text-amber-900">
                Rates generated by this calculator are <strong>indicative estimates</strong> based on standard courier partner rate cards. In accordance with operations policy, the final shipping charge is confirmed by SS Courier admin staff upon physical intake and weight verification at our hub.
              </p>
            </div>
          </div>
